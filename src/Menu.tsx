    ...
    <div className="min-w-150 py-8 flex flex-col items-center gap-15">
      <div className="flex flex-row gap-8">
        <div className="flex items-center gap-2">
          <img className="pixelated w-20" src="./src/assets/p.png"></img>
          <img className="pixelated w-20" src="./src/assets/i.png"></img>
          <img className="pixelated w-20" src="./src/assets/x.png"></img>
          <img className="pixelated w-20" src="./src/assets/e.png"></img>
          <img className="pixelated w-20" src="./src/assets/l.png"></img>
        </div>
        <div className="flex items-center gap-2">
          <img className="pixelated w-20" src="./src/assets/p.png"></img>
          <img className="pixelated w-20" src="./src/assets/a.png"></img>
          <img className="pixelated w-20" src="./src/assets/i.png"></img>
          <img className="pixelated w-20" src="./src/assets/r.png"></img>
